class CategoriesController < ApplicationController
  ...
  param :name, String, :desc => "Name of the new category; must be under category node/hash", :required => true
  ...
  param :name, String, :desc => "new name; must be under category node/hash", :required => true
